...
?><!DOCTYPE html>
<html><head><meta charset="utf-8"><title><?= htmlspecialchars($pageTitle[$p]) ?> - 工具箱管理后台</title>
...
<a class="menu-item <?= $p==='admin-config'?'active':'' ?>" href="?p=admin-config">🔐 管理员配置</a>
<a class="menu-item <?= $p==='update'?'active':'' ?>" href="?p=update">⬇ 系统更新</a></div>
</div></div>
